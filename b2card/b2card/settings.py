"""
Django settings for b2card project.
...
URL_PER = ['/inicial/','/autenticacao/', '/autenticacao/login/', '/autenticacao/logout/','/autenticacao/not_permitted/', '/autenticacao/falha/', '/alterar/']
BASE_URL = '/'
...
SECRET_KEY = '3^)9whzfqn8i0+%$lsl(sd6elg@^b^g(&(lt)-zssjke6)t_+('
...
WSGI_APPLICATION = 'b2card.wsgi.application'
