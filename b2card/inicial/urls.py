...
urlpatterns = [
    ...
    url(r'^api/total_horas_lancadas_dia/(?P<data_informada>[0-9]+)/$', views.buscar_alocacao_dia),
    url(r'^api/ajustar_porcentagem_profissional/$', views.ajustar_porcentagem_profissional)
]
